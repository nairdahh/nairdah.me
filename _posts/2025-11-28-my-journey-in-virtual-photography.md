---
layout: blog-post
title: "my journey in virtual photography"
date: 2025-11-28
author: nairdah
categories: [blog]
...
[![Hall of FRAMED](/assets/hof.png){: .nav-image-button .center .aboutvpimg}](https://framedsc.com/HallOfFramed/){: .img-href .vpbuttonclass2}
{: .text-center}
...
[![Otis_Inf Patreon](/assets/otis.png){: .nav-image-button .center .aboutvpimg}](https://www.patreon.com/c/Otis_Inf/home){: .img-href .vpbuttonclass2}
{: .text-center}
...
{% include elements/avatar.html url="https://shkegulka.github.io/" name="shkegulka" img="/assets/inspiration-avatars/shkegulka.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://originalnicodr.github.io/" name="originalnicodr" img="/assets/inspiration-avatars/nico.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/IronGauntlet05" name="Iron" img="/assets/inspiration-avatars/iron.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/Hary1495g" name="Hary" img="/assets/inspiration-avatars/hary.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://pictureamoebae.tumblr.com/" name="amoebae" img="/assets/inspiration-avatars/amoebae.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/Gingerbread_94" name="gingerbread" img="/assets/inspiration-avatars/gingerbread.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/rizaldefa23" name="RIZAL" img="/assets/inspiration-avatars/rizal.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/NattyDread011" name="Dread" img="/assets/inspiration-avatars/dread.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/solemist" name="solemist" img="/assets/inspiration-avatars/solemist.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/Eul_keke" name="Eul Keke" img="/assets/inspiration-avatars/keke.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://soulsurrender.com/" name="soulsurrender" img="/assets/inspiration-avatars/soulsurrender.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://flickr.com/photos/191917731@N04" name="tzero" img="/assets/inspiration-avatars/tzero.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://www.flickr.com/photos/alexk0nstantin/" name="AlexK0nstantin" img="/assets/inspiration-avatars/alexk0nstantin.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://x.com/Lidertzz" name="Lidertz" img="/assets/inspiration-avatars/lidertz.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://www.flickr.com/photos/overflow2point0/" name="Jim2point0" img="/assets/inspiration-avatars/jim2point0.png" tippy="tippy-bottom" %}
{% include elements/avatar.html url="https://www.flickr.com/photos/sammirllm25/" name="SammirLlm" img="/assets/inspiration-avatars/sammir.png" tippy="tippy-bottom" %}
</div>
...
- [FRAMED](https://framedsc.com/) - the hub for virtual photography enthusiasts
- [Hall of FRAMED](https://framedsc.com/HallOfFramed/) - curated collection of outstanding work
- [Steam group: art in games](https://steamcommunity.com/groups/art_in_games) - Beautiful Screenshot Lovers
- [FRAMED Discord](https://framedsc.com/joinus.htm) - join the community

- **tools & guides:**
- [Otis_Inf on Patreon](https://www.patreon.com/c/Otis_Inf/home) - professional virtual photography tools
- [FRAMED guides](https://framedsc.com/) - comprehensive tutorials and techniques

**social & inspiration:**
follow the creators i mentioned above on [Twitter/X](https://x.com/) and [Bluesky](https://bsky.app/starter-pack/did:plc:2j7zvifa25vksvpguuccxucj/3l755fn5oiv27)
